...
import be.nbb.util.NativeLibraryLoader;
...
//            System.loadLibrary("ntlmauth");
            NativeLibraryLoader.fromSystemProperties()
                    .route("^Windows.*", "^x86$", ".*", "/x86/SSO")
                    .route("^Windows.*", "^amd64$", ".*", "/x64/SSO")
                    .prefix("jtds-" + Driver.getVersion() + "-")
                    .load("ntlmauth");
